...
\begin{figure}[!htbp]
	\centering
	  \includegraphics[scale=0.23]{./figures/tr.png}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	  \includegraphics[scale=0.11]{./figures/blindman.png}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	  \includegraphics[scale=0.22]{./figures/motivation.png}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!htbp]
	\centering
	  \includegraphics[scale=0.45]{./figures/HiCSprove.png}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	  ...
	  \hspace{1cm}
	  \includegraphics[scale=0.25]{./figures/3Dbisection.png}
...
\begin{itemize}
	...
	\end{figure}
			\vspace{-0.3cm}
		\item 3D case: ~~
	\movie[externalviewer,label=mymovie,width=0.05in,height=0.35in,poster]{}{./figures/3Dschematic.avi}
	\hspace*{-0.5cm}\includegraphics[scale=0.03]{./figures/play.png}
...
\vspace{-0.3cm}
\begin{center}
	\movie[externalviewer,label=mymovie,width=0.3in,height=0.1in,poster]{}{./figures/gauss.avi}
	\hspace*{-0.6cm}\includegraphics[scale=0.03]{./figures/play.png}
	  \hyperlinkmovie[play]{mymovie}{\textcolor{blue}{ ~~Movie: Iteration procedure}}
\end{center}
}
\end{frame}
...
\begin{figure}[!htbp]
	\centering
	  \includegraphics[scale=0.25]{./figures/gauss50D.png}
	  \includegraphics[scale=0.25]{./figures/gauss50D_dist.png}
%    \caption{: 
...
%\footnotesize{
%    \begin{itemize}
%        \item AHiCS can approximate the minimizer 
%        \item Setup: $\rho_0 = 0.3$, $m_{\max}=32$, $\eta =
%            (\sqrt{5}-1)/2$, initial position is randomly generated.
%    \end{itemize}
%    }
%\begin{figure}[!htbp]
...
\normalsize{
\begin{center}
	\movie[externalviewer,label=mymovie,width=0.2in,height=0.2in,poster]{}{./figures/dw1.avi}
	\hspace*{-0.7cm}\includegraphics[scale=0.03]{./figures/play.png}
	  \hyperlinkmovie[play]{mymovie}{\textcolor{blue}{ ~~Movie: Iteration procedure}}
\end{center}
}
\end{frame}
...
\begin{frame}{Ackley Function: 2D}
	...
	\end{itemize}
	\begin{center}
		\movie[externalviewer,label=mymovie,width=0.5in,height=0.2in,poster]{}{./figures/ackley090.avi}
		\hspace*{-0.7cm}\includegraphics[scale=0.03]{./figures/play.png}
		  \hyperlinkmovie[play]{mymovie}{\textcolor{blue}{ ~~Movie: Iteration procedure}}
	\end{center}
	...
	\end{itemize}
	\begin{center}
		\movie[externalviewer,label=mymovie,width=0.5in,height=0.2in,poster]{}{./figures/ackley055.avi}
		\hspace*{-0.7cm}\includegraphics[scale=0.03]{./figures/play.png}
		  \hyperlinkmovie[play]{mymovie}{\textcolor{blue}{ ~~Movie: Iteration procedure}}
	\end{center}
\end{frame}
...
\begin{figure}[!htbp]
	\centering
      \includegraphics[scale=0.28]{./figures/ackley100Drandr_dist.png}
%    \subfigure[$\rho_0=0.05$]{
%          \includegraphics[scale=0.15]{./figures/ackley100Drandr0_05_dist.png}
%      }
%    \subfigure[$\rho_0=0.1$]{
%          \includegraphics[scale=0.15]{./figures/ackley100Drandr0_1_dist.png}
%      }
%    \subfigure[$\rho_0=0.5$]{
%          \includegraphics[scale=0.15]{./figures/ackley100Drandr0_5_dist.png}
%      }
%    \subfigure[$\rho_0=0.8$]{
%          \includegraphics[scale=0.15]{./figures/ackley100Drandr0_8_dist.png}
%      }
