...
\author[xtu]{Yunqing Huang \corref{cor}}
...
The produced discretization points are as large as $2m^{d-1}$ in
...
\begin{algorithm}
	...
	\label{alg:simplex}
\begin{algorithmic}
	\STATE Give an $d\times(d+1)$-order zero matrix $x(1:d,1:d+1)$
	\FOR {$i=1:1:d$}
...
simplex, more points can be added to discretize $O(x_k, \rho)$.
