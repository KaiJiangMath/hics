...
practical HiCS, as the Algorithm \ref{alg:refined} shows. The computational
amount is not larger than $(d+1)m_{\max}$ in each iteration, 
$m_{\max}$ is the maximum number of rotation,
which is linearly dependent on the dimension of optimization problems.
