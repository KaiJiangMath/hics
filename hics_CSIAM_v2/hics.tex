...
\end{algorithm}
\textcolor{blue}{ 
In the following, we will give the finite-step convergent property of the Algorithm
\ref{alg:HiCS}.
}
...
\textcolor{blue}{ 
From the Algorithm \ref{alg:HiCS}, one can find that, at each
iteration, the HiCS minimizes a $(d-1)$-dimensional subproblem for a
...
\textcolor{blue}{
In practice, it requires to numerically imitate the minimization
