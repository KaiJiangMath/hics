...
\begin{document}
	...
	\title[Hill-climbing method with a stick]{A finite-step convergent method for unconstrained optimization}
...
direction and then the step length along with the search
